const express = require('express'); const app = express(); const meme = [   "https://i.imgur.com/R1nOnEC.jpeg", 
...
"https://i.ibb.co/YtjxDsX/image.jpg", 
  ...
  "https://i.ibb.co/0m9zgGN/image.jpg", 
  ...
  "https://i.ibb.co/wCTZzX1/image.jpg" ]; app.get('/meme', (req, res) => { res.json(meme); }); app.listen(3000, () => { console.log('API server running on port 3000'); });
